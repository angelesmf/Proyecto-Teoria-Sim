...
import BotonImg from './ui/Boton-Img'
import BotonModal from './ui/BotonModal'
...
export default function BarraAcciones() {
  return (
    <header className='h-screen w-32 bg-slate-200 flex flex-col gap-2 p-4'>
      ...
      <BotonModal texto='Ordenar Monto' className='bg-green-500'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          viewBox='0 0 24 24'
          fill='currentColor'
      ...
      <BotonModal texto='Ordenar Total' className='bg-violet-500'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          viewBox='0 0 24 24'
          fill='currentColor'
      ...
      <BotonImg texto='Ordenar Tipo Auto'>
        <img src={Auto} alt='Auto' />
      </BotonImg>
      <BotonImg texto='Ordenar Tipo Camion'>
        <img src={Camion} alt='Camion' />
      </BotonImg>

      <BotonImg texto='Ordenar Tipo Trailer'>
